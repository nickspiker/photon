...
The motivating topology was the v4/v6 split (Nick v6-only cellular ↔ Sarah v4-only DSL — NO common IP version, direct socket impossible), not classic symmetric↔symmetric NAT; the pipe covers both — any pair that can't meet directly meets at the dual-stack DO.
