...
description: "PINNED: photon install on Jennifer's Windows box corrupted the OS dark-theme Start-menu/search text (000000→FFFFFF on F0F0F0); toggling Windows light/dark fixed it; investigate later"
metadata: 
  node_type: memory
  type: project
...
Reported 2026-07-24 by Jennifer: right after installing photon on Windows, the WINDOWS OS dark-mode search-results/Start-menu text went unreadable (was 000000 on F0F0F0, became FFFFFF).
