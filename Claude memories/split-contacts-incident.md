...
metadata: 
  ...
  modified: 2026-08-11T07:47:30.141Z
---
...
Ground truth incoming: boot STORAGE census (f67cf8b) logs per-contact table id + loaded row count + a loud DUPLICATE CONTACT line (same handle_proof, different handle_hash). Read the NEXT Nick/friend-M logs before designing the repair.
