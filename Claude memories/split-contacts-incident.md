...
Ground truth incoming: boot STORAGE census (f67cf8b) logs per-contact table id + loaded row count + a loud DUPLICATE CONTACT line (same handle_proof, different handle_hash). Read the NEXT Nick/Mary logs before designing the repair.
