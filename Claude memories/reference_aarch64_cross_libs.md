...
3. Write `cross-libs/aarch64/pkgconfig/foo.pc` mirroring `x11.pc`: `prefix=/usr/aarch64-redhat-linux/sys-root/fc42/usr`, `libdir=/mnt/Harbor/Code/photon/cross-libs/aarch64`, `Libs: -L${libdir} -lfoo`, `Cflags: -I${includedir}`.
