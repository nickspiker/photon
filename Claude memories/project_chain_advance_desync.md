...
**THE FIX — IMPLEMENTED 2026-06-28, commit 9bf1193** (was designed in [docs/chain-explicit-weave.md](/mnt/Harbor/Code/photon/docs/chain-explicit-weave.md); ALL chain+friendship tests pass, desktop dev build links+signs clean; still needs live Nick↔phone validation, rapid-fire + crossed). Two layers, both landed:
