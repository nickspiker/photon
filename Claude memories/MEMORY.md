...
- [project_wave_card.md](project_wave_card.md) — WAVE CARD: wave.env EXCHANGE 2026-09-12 (3-ch u8 stochastic tensor VSF per party, S0=1, cumulative-stack render + tip AA, colouring parked; fluor palette vsf() bake)
