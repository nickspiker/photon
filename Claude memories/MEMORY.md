...
- [project_vault_seal_failures.md](project_vault_seal_failures.md) — OPEN 2026-09-04: 43 blocks on Leviathan unreadable (seals fail on READ at rest); ordering+scratch+fence ruled out, media/RAM suspected — capture forensics before nuking
