...
- [project_vault_op_latency.md](project_vault_op_latency.md) — CONVICTED 2026-08-21: vault puts ~900ms FLAT size-independent (fsync ×2 rings); click-hang = reads behind the write queue; fix = fstate ping-pong → librarian group commit → UI-drain audit
