...
- [project_render_storm_lag.md](project_render_storm_lag.md) — 2026-08-15: lag = VAULT MUTEX contention (UI-tick avatar probe vs persist writers)
...
- [project_call_no_ring_incident.md](project_call_no_ring_incident.md) — no-ring class; 2026-09-11 relay-carried express + lane-aware ring lease 8f2fea8 (no direct path = no beats); earlier fixes aa74da5/6402ef0
...
- [project_wave_card.md](project_wave_card.md) — WAVE CARD full arc SHIPPED 2026-09-12 PHCALL7: clean archive verbatim keep + duck profile, plaid nowhere at rest, [4,bins] Q48 wave.env, coverage AA + tuned bands + AGB colour, music pigeons + player
