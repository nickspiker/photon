...
- [project_log_sweep_eats_fresh.md](project_log_sweep_eats_fresh.md) — worker :17 sweep DELETED an 18-min-old submission (24h rule violated); instrumented worker live, tail armed for 14:17Z; fix = key-embedded eagle osc, not uploaded()
