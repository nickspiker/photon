                ...
                let query_result = if let Some(error) = result.error {
                    ...
                    if is_ours {
                        ...
                        *identity_seed_store.lock().unwrap() = Some(identity_seed);
                        ...
                        let mut friendships = crate::storage::friendship::load_all_friendships(
                            &friendship_ids,
                            &storage,
                        );
