...
fn fs_main(in: VertOut) -> @location(0) vec4<f32> {
    let c = textureSample(t_frame, s_frame, in.uv);
    // CPU buffer holds straight alpha; Wayland compositors expect premultiplied.
...
impl Renderer {
    ...
    async fn init(window: &'static Window, width: u32, height: u32) -> Self {
        ...
        let adapter = instance
            ...
            .await
            .expect("wgpu: no Vulkan adapter found");
        ...
        let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            fragment: Some(wgpu::FragmentState {
                ...
                targets: &[Some(wgpu::ColorTargetState {
                    format:     surface_format,
                    blend:      None, // shader premultiplies; write directly to surface
