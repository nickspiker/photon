...
pub fn text(msg: Msg) -> Cow<'static, str> {
    match msg {
        ...
        Msg::BringIntoGroup => "Bring into a group".into(),
        Msg::NewGroup => "New group".into(),
        Msg::GroupTitlePrompt => "Group title".into(),
        Msg::FoundGroupPill => "Found it".into(),
        Msg::HistoryFromGenesis => "Newcomers see everything".into(),
        Msg::HistoryFromJoin => "Newcomers see from when they join".into(),
        Msg::GroupAlone => "just you".into(),
        Msg::JoiningStatus => "joining\u{2026}".into(),
        ...
        Msg::GroupPageName(p) => match p { crate::ui::state::GroupPage::About => "About", crate::ui::state::GroupPage::Add => "Add", crate::ui::state::GroupPage::Manage => "Manage" }.into(),
        Msg::Members => "Members".into(),
        Msg::MemberStanding => "standing".into(),
        ...
        Msg::LeaveGroupPill { armed } => if armed { "Tap again \u{2014} leave" } else { "Leave" }.into(),
        Msg::LeaveGroupNote => "Leaving posts your signed leave; the others mint a new key you will not hold. Your copy of the history stays readable here.".into(),
        Msg::AddToGroupNote => "Anyone you add is offered the group over your conversation with them; they join by tapping Join.".into(),
        Msg::NobodyToAdd => "Everyone you know is already here.".into(),
        Msg::YouLeftNote => "You left this group.".into(),
        Msg::GroupsExplainHead => "How groups work".into(),
        Msg::GroupsExplainProse => "A group is a friendship with more than two people. Nobody owns it: the person who started it is just its first member.\nYou come in thru a friend. A member offers you the group over the conversation you already have with them, and you join by tapping Join. Nobody can put you in a group.\nAnyone in the group can bring in anyone they know. Nobody can remove anyone but themselves. If someone is unwelcome, the others start a new group and let the old one wither.\nThe group's name is just a label everyone shares and anyone can change. Its real identity is a random number minted when it began, so a name can never be squatted, sold, or stolen.\nEvery message is encrypted once and sent to every member. Leaving posts your signed departure; the others mint a new key you will not hold, and your copy of the history stays readable to you.\nHistory before you joined is not shared unless the group was started that way.".into(),
        Msg::DefaultHistoryHead => "Groups you start".into(),
        Msg::DefaultHistoryNote => "What newcomers can see, fixed when a group is founded.".into(),
        Msg::YourGroups => "Your groups".into(),
        Msg::NoGroupsYet => "No groups yet. Open a friend's panel and choose Bring into a group.".into(),
