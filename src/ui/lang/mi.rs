...
pub fn text(msg: Msg) -> Cow<'static, str> {
    match msg {
        ...
        Msg::SecurityRemove { armed } => if armed { "Wehe — ka mau tonu te taputapu ki a koe — e tino hiahia ana?" } else { "Wehe — ka mau tonu te taputapu ki a koe" }.into(),
        Msg::SecurityShred { armed } => if armed { "Haehae — e tino hiahia ana?" } else { "Haehae" }.into(),
        Msg::SecurityRemoveShred { armed } => if armed { "Wehe — tukua ki te rangatira hou — e tino hiahia ana?" } else { "Wehe — tukua ki te rangatira hou" }.into(),
        ...
        Msg::SecurityRemoveHint => "Ka wehe tēnei pūrere i tō kāhui, ka mukua hoki ōna raraunga; ka mau tonu te taputapu ki tōu tohu (hei rawa tāpui). Ka ora tonu tō tuakiri me tō hītori mā ō pūrere kē.".into(),
        Msg::SecurityShredHint => "Ka muku whakamuna i te pātaka me te tuakiri i tēnei pūrere — kāore e taea te whakahoki. Ka NOHO TONU te pūrere i tō kāhui; ki te hoatu i te pūrere, whakamahia kē a Wehe — tukua ki te rangatira hou.".into(),
