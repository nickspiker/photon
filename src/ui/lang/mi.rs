...
pub fn text(msg: Msg) -> Cow<'static, str> {
    match msg {
        ...
        Msg::BringIntoGroup => "Kawea ki tētahi rōpū".into(),
        Msg::NewGroup => "Rōpū hou".into(),
        Msg::GroupTitlePrompt => "Taitara rōpū".into(),
        Msg::FoundGroupPill => "Whakatūria".into(),
        Msg::HistoryFromGenesis => "Ka kite ngā mema hou i ngā mea katoa".into(),
        Msg::HistoryFromJoin => "Ka kite ngā mema hou mai i tō rātou urunga".into(),
        Msg::GroupAlone => "ko koe anake".into(),
        Msg::JoiningStatus => "e uru ana\u{2026}".into(),
        ...
        Msg::GroupPageName(p) => match p { crate::ui::state::GroupPage::About => "Mō", crate::ui::state::GroupPage::Add => "Tāpiri", crate::ui::state::GroupPage::Manage => "Whakahaere" }.into(),
        Msg::Members => "Ngā mema".into(),
        Msg::MemberStanding => "e tū ana".into(),
        ...
        Msg::LeaveGroupPill { armed } => if armed { "Pāwhiritia anō \u{2014} wehe" } else { "Wehe" }.into(),
        Msg::LeaveGroupNote => "Ka tukuna tō wehenga hainatia; ka hanga ngā mema kī hou kāore i a koe. Ka noho pānuitia tō kape o te hītori i konei.".into(),
        Msg::AddToGroupNote => "Ka tukuna te rōpū ki te tangata ka tāpirihia e koe mā tō kōrero ki a ia; ka uru mā te pāwhiri i Uru.".into(),
        Msg::NobodyToAdd => "Kei konei kē ō hoa katoa.".into(),
        Msg::YouLeftNote => "Kua wehe koe i tēnei rōpū.".into(),
        Msg::GroupsExplainHead => "Me pēhea ngā rōpū".into(),
        Msg::GroupsExplainProse => "He hoatanga te rōpū, engari he tokomaha ake i te tokorua. Kāore he rangatira: ko te tangata nāna i tīmata, ko ia noa te mema tuatahi.\nKa uru koe mā tētahi hoa. Ka tukuna e tētahi mema te rōpū ki a koe i roto i tō kōrero kē ki a ia, ā, ka uru koe mā te pāwhiri i Uru. Kāore e taea e tētahi te whakauru i a koe ki tētahi rōpū.\nKa taea e tētahi o te rōpū te kawe mai i tētahi e mōhio ana ia. Kāore e taea e tētahi te pana i tētahi atu, ko ia anake. Mēnā kāore tētahi e manakohia, ka tīmata ngā mema kē i tētahi rōpū hou, ka waiho te mea tawhito kia memeha.\nHe tapanga noa te ingoa o te rōpū e tohatohaina ana, ā, ka taea e tētahi te huri. Ko tōna tuakiri pono he nama matapōkere i hangaia i te tīmatanga, nō reira kāore e taea te ingoa te tango, te hoko, te tāhae rānei.\nKa whakamunatia ia karere kotahi te wā, ka tukuna ki ia mema. Ka tukuna e te wehenga tō haere hainatia; ka hanga ngā mema kē i te kī hou kāore i a koe, ā, ka noho pānuitia tō kape o te hītori ki a koe.\nKāore te hītori i mua i tō urunga e tohatohaina, mēnā kāore te rōpū i tīmata pērā.".into(),
        Msg::DefaultHistoryHead => "Ngā rōpū ka tīmatahia e koe".into(),
        Msg::DefaultHistoryNote => "Ngā mea ka kitea e ngā mema hou, ka whakaritea i te whakatūnga o te rōpū.".into(),
        Msg::YourGroups => "Ō rōpū".into(),
        Msg::NoGroupsYet => "Kāore anō he rōpū. Whakatuwheratia te paewhiri o tētahi hoa, ka kōwhiri i Kawea ki tētahi rōpū.".into(),
