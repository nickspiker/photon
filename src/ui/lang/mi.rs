...
pub fn text(msg: Msg) -> Cow<'static, str> {
    match msg {
        ...
        Msg::DeviceBrandedHint => "Kei te mau tonu t\u{0113}nei taputapu ki te tohu o t\u{014D}na rangatira o mua. M\u{0101} r\u{0101}tou e tuku mai i t\u{014D} r\u{0101}tou wh\u{0101}rangi K\u{0101}hui (Tuku), m\u{0101} te waha atu r\u{0101}nei hei \u{201C}rangatira hou\u{201D}.".into(),
        Msg::SecurityRemove { armed } => if armed { "Wehe — ka pupuri au i te p\u{016B}rere — e tino hiahia ana?" } else { "Wehe — ka pupuri au i te p\u{016B}rere" }.into(),
