...
- Then **NAT traversal relay tier** (see Messaging/protocol above): the symmetric↔symmetric / double-CGNAT case (peer_m↔peer_m) that direct can never reach.
