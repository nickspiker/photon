...
**Status:** spec for Phase B (braid v2), pre-implementation. Companion to `braid.md` §14 (which sketches the fleet plane broadly); THIS document is the concrete design the code will follow. Supersedes §14 where they disagree.
