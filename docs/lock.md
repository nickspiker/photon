...
- EPOCH SCALE: DECIDED 2026-09-26 — minted stamps stay on the legacy scale (POSIX seconds from the label 1969-07-20T20:17:40 UTC); the §1.1 TAI definition (20:17:48 TAI, exactly 29 s ahead since 2017) lives in vsf as conversions only. No +29 s flip (Nick: "I don't want to change anything, the way it was was fine").
