# The Lexicon — proper definitions, before the debotcherization

Photon names its surfaces with old words carrying exact meanings. This file holds those meanings as a 1960 dictionary gave them — captured from the physical page by the Lumis rig (frame-averaged photographs, 2026-09-02, `~/Desktop/Lumis images/interaction/`), because the modern paraphrases have been worn smooth of everything useful. Pages quote one-line epigraphs from here; this file keeps the fuller senses and the etymologies.
